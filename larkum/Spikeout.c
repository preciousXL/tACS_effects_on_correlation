...
#define vrefrac _p[2]
#define vrefrac_columnindex 2
#define grefrac _p[3]
#define grefrac_columnindex 3
#define i _p[4]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 SpikeOut Spikeout.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "Spikeout.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
